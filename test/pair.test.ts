...
describe('Pair', () => {
  ...
  const USDT_TEST = new Token(ChainId.TESTNET, '0xF33B9d4C3b1786c8C215188F8D9d6d679019CEc3', 6, 'USDT', 'Tether')
  const USDC_TEST = new Token(ChainId.TESTNET, '0xD9Bc92569C14C1FB62Ff0CeE95aCE5d5de4b36EA', 6, 'USDC', 'USD Coin')
  ...
  describe('#getAddress', () => {
    it('returns the correct address', () => {
      expect(Pair.getAddress(USDC_TEST, USDT_TEST)).toEqual('0x49fA061Fec0A461926C34251b3466358e16113B3')
    })
  })
